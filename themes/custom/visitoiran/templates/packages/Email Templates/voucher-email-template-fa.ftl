...
<div class="voucher">
    <div class="header-section">
        ...
        <h2 class="title">رسید خرید</h2>
    </div>

    <div class="content-section">
        <div class="row">
            <div class="column">
                <h4 class="header"><span>اطلاعات تور</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td>
                            <p><strong>نام تور</strong></p>
                        </td>
                        <td>
                            <p>${data.name}</p>
                        </td>
            ...
            <div class="column">
                <h4 class="header"><span>اطلاعات هتل</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td>
                            <p><strong>نام هتل</strong></p>
                        </td>
                        <td>
                            <p>
        ...
        <div class="row">
            <div class="column">
                <h4 class="header"><span>اطلاعات مسافر</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                        <#list data.passengerInfo as passenger >
                        <tr>
                            <td class="six wide">
                                <p><strong>مسافر ${ passenger?index }</strong></p>
                            <td class="ten wide">
            ...
            <div class="column">
                <h4 class="header"><span>اطلاعات تماس</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td>
        ...
        <div class="row">
            <div class="column">
                <h4 class="header"><span>اطلاعات پرداخت</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    ...
                    <#list data.paymentInfo as payment >
                        ...
                        <tr>
                            <td>
                                <p><strong>شماره پیگیری</strong></p>
                            <td>
            ...
            <div class="column">
                <h4 class="header"><span>اطلاعات آژانس</span></h4>
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td>
        ...
        <div class="row cancellation-policy">
            <h4 class="header"><span>شرایط لغو</span></h4>
            <p>
